...
int main()
{
  ...
  fclose(fp);
  printf("Your current country was defaulted to India. You can change this at anytime from the settings menu\n");
  ...
  do
  {
    ...
    {
       case 1 : system("cls");
                printf("Enter Places you want to visit(Separated by ','):\n");
                fflush(stdin);
                scanf("%[^\n]s",wish_list);
                ...
                printf("Items successfully added to bucket list\nPress enter to continue\n");
                getchar();
                getchar();
                break;
      ...
      case 2 : label_2 :
               ...
               switch(ch2)
               {
                  ...
                  case 2 : counter_path=0;
                           ...
                           printf("%s\nPress enter to continue",list[so].name);
               }
               getchar();
               getchar();
               break;
        ...
        case 3: do
                {
                    ...
                    switch(ch2)
                    {
                        case 1: printf("Enter your current country\n");
                                fflush(stdin);
                                scanf("%[^\n]s",set);
                                ...
                                if(i!=-1)
                                {
                                    so=i;
                                    final_path[0]=so;
                                    printf("Your current location has been set to %s",set);
                                }
                                else
